...
module.exports = {
    ...
    bot: async (urlToVisit) => {
        ...
        try {
            ...
            console.log(`bot visiting ${CONFIG.APPURL}`);
            ...
            await page.fill('textarea[id="shared"]', `{"secret":"${CONFIG.APPFLAG}"}`);
            await page.fill('input[id="title"]', 'Flag');
            await page.fill('textarea[id="template"]', '{{secret}}');
            await page.click('button#saveBtn');
            await sleep(1000);
            await page.click('button#saveToCookieBtn');
            await sleep(1000);
            console.log("data filled and saved to cookie...");
